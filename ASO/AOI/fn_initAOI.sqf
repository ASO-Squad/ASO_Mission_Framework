...
Parameters:
	...
	_main					- The main AOI this AOI belongs to, leave it blank if you want this AOI to be its own boss 
...
Examples:
    [_thisTrigger, _main, "My Header", "Kill everyone!", "attack", "west", ] spawn aso_fnc_initAOI
...
params ["_trigger", ["_main", objNull], ["_objectiveHeader", ""], ["_objectiveHeader", ""], ["_objectiveDescription", ""], ["_taskType", ""], ["_taskOwner", ""], ["_taskPriority", 0], ["_taskParent", ""]];
...
// 5 = The AOI this one belongs to
// 6 = Tasks
_thisAOI = [_trigger, _objectiveHeader, _objectiveDescription, [], [], _main, []];
