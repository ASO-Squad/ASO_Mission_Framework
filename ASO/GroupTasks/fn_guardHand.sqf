/* ----------------------------------------------------------------------------
Description:
    A function for a group to guard an AOI. 
    They allways protect their AOI and should never leave it, 
    and your can hand place them, put them in fancy animantions and stuff.
...
Example:
    [myGroup, myTrigger, "INFANTRY"] call aso_fnc_guardHand
