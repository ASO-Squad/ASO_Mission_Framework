...
if (isServer) then
{
	[_namespace, _saveByName, _prefix, _varname] call aso_fnc_saveVar;
}
else
{
	[_namespace, _saveByName, _prefix, _varname] remoteExecCall ["aso_fnc_saveVar", 2, false]; // Call this on the server
};		